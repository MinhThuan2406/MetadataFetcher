...
TECHNICAL_USE_CASE = "Developer Tools"

def fetch_developer_tools_metadata(tool_name: str) -> Dict:
    """Fetch metadata for a developer tool, using PyPI, generic fetcher, and fallbacks as needed."""
